...
$(document).ready(function () {
	...
	if($('#categorieslist').length > 0) {
		$('#categorieslist').DataTable({
			...
			"columns": [
				...
				{
					"render": function (data, type, row) {
						return '<h2 class="table-avatar d-flex align-items-center"><a href="contact-details" class="avatar"><img class="avatar-img" src="' + row['customer_image'] + '" alt="User Image"></a><a href="contact-details" class="profile-split d-flex flex-column">' + row['customer_name'] + ' <span>' + row['customer_no'] + ' </span></a></h2>';
					}
				},
				{ "data": "phone" },
				{ "data": "email" },
	...
	if($('#companieslist').length > 0) {
		$('#companieslist').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h2 class="table-avatar d-flex align-items-center"><a href="company-details" class="company-img"><img class="avatar-img" src="'+row['company_image']+'" alt="User Image"></a><a href="company-details" class="profile-split d-flex flex-column">'+row['company_name']+'</a></h2>';
				}},
				{ "data": "phone" },
				{ "data": "email" },
				{ "render": function ( data, type, row ){
	...
	if($('#leads_list').length > 0) {
		$('#leads_list').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h2 class="table-avatar d-flex align-items-center"><a href="company-details" class="company-img"><img class="avatar-img" src="'+row['company_image']+'" alt="User Image"></a><a href="company-details" class="profile-split d-flex flex-column">'+row['company_name']+'<span>'+row['company_address']+' </span></a></h2>';
				}},
				{ "data": "phone" },
				{ "data": "email" },
				{ "render": function ( data, type, row ){
	...
	if($('#recent-project').length > 0) {
		...
		"columns": [
			{ "render": function ( data, type, row ){
				return '<h2 class="table-avatar d-flex align-items-center"><a href="project-details" class="company-img"><img class="avatar-img" src="'+row['priority_img']+'" alt="User Image"></a><a href="project-details" class="profile-split d-flex flex-column">'+row['priority_name']+'</a></h2>';
			}},
			{ "render": function ( data, type, row ){
				return '<h2 class="table-avatar d-flex align-items-center"><a href="company-details" class="company-img"><img class="avatar-img" src="'+row['recent_img']+'" alt="User Image"></a><a href="company-details" class="profile-split d-flex flex-column">'+row['recent_name']+'</a></h2>';
			}},
			{ "render": function ( data, type, row ){
	...
	if($('#lead-project').length > 0) {
		...
		"columns": [
			{ "data": "lead" },
			{ "render": function ( data, type, row ){
				return '<h2 class="table-avatar d-flex align-items-center"><a href="company-details" class="company-img"><img class="avatar-img" src="'+row['lead_img']+'" alt="User Image"></a><a href="company-details" class="profile-split d-flex flex-column">'+row['lead_name']+'<span>'+row['lead_city']+' </span></a></h2>';
			}},
			{ "data": "phone" },
			{ "render": function ( data, type, row ){
	...
	if($('#project-list').length > 0) {
		$('#project-list').DataTable({
			...
			"columns": [
				...
				{ "render": function ( data, type, row ){
					return '<h2 class="table-avatar d-flex align-items-center"><a href="project-details" class="company-img"><img class="avatar-img" src="'+row['pro_img']+'" alt="User Image"></a><a href="project-details" class="profile-split d-flex flex-column">'+row['name']+'</a></h2>';
				}},
				{ "render": function ( data, type, row ){
					return '<h2 class="table-avatar d-flex align-items-center"><a href="company-details" class="company-img"><img class="avatar-img" src="'+row['client_img']+'" alt="User Image"></a><a href="company-details" class="profile-split d-flex flex-column">'+row['client']+'</a></h2>';
				}},   
				{ "render": function ( data, type, row ){
	...
	if($('#analytic-contact').length > 0) {
		$('#analytic-contact').DataTable({
			...
			"columns": [
				{ "render": function ( data, type, row ){
					return '<h2 class="table-avatar d-flex align-items-center"><a href="contact-details" class="avatar"><img class="avatar-img" src="'+row['lead_img']+'" alt="User Image"></a><a href="contact-details" class="profile-split d-flex flex-column">'+row['lead_name']+'<span>'+row['lead_city']+' </span></a></h2>';
				}},
				{ "data": "email" },
				{ "data": "phone" },
				{ "data": "date" }
	...
	if($('#analytic-company').length > 0) {
		$('#analytic-company').DataTable({
			...
			"columns": [
				{ "render": function ( data, type, row ){
					return '<h2 class="table-avatar d-flex align-items-center"><a href="company-details" class="company-img"><img class="avatar-img" src="'+row['lead_img']+'" alt="User Image"></a><a href="company-details" class="profile-split d-flex flex-column">'+row['lead_name']+'</a></h2>';
				}},
				{ "data": "email" },
				{ "data": "phone" },
				{ "data": "date" }
	...
	if($('#analytic-lead').length > 0) {
		$('#analytic-lead').DataTable({
			...
			"columns": [
				{ "data": "name" },
				{ "render": function ( data, type, row ){
					return '<h2 class="table-avatar d-flex align-items-center"><a href="lead-details" class="company-img"><img class="avatar-img" src="'+row['lead_img']+'" alt="User Image"></a><a href="lead-details" class="profile-split d-flex flex-column">'+row['lead_name']+'<span>'+row['lead_city']+' </span></a></h2>';
				}},
				{ "data": "phone" },
				{ "render": function ( data, type, row ){
