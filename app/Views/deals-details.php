            ...
            <div class="col-md-12">
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-8">
                            <ul class="contact-breadcrumb">
                                ...
                                <li class="before-none">
                                    <a href="#" class="btn btn-primary add-popup"><i class="ti ti-square-rounded-plus"></i>Add</a>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="contact-wrap">
                    <div class="contact-profile">
                        ...
                        <div class="name-user">
                            <h5>Tremblay and Rath <span class="star-icon"><i class="fa-solid fa-star"></i></span></h5>
                        ...
                        <span class="badge badge-light"><i class="ti ti-lock"></i>Private</span>
                            <div class="dropdown action-drops">
                                <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                    <span class="bg-success"><i class="ti ti-thumb-up me-2"></i>Won<i class="ti ti-chevron-down ms-2"></i></span>
                                </a>
            ...
            <div class="col-xl-3 theiaStickySidebar">
                <div class="contact-sidebar">
                    ...
                    <div class="con-sidebar-title">
                        <h6>Owner</h6>
                        <a href="javascript:void(0);" class="com-add" data-bs-toggle="modal" data-bs-target="#owner"><i class="ti ti-circle-plus me-1"></i>Add New</a>
                    </div>	
                    <ul class="deals-info">
                        <li>
                    ...
                    <div class="con-sidebar-title">
                        <h6>Contacts</h6>
                        <a href="javascript:void(0);" class="com-add" data-bs-toggle="modal" data-bs-target="#add_contact"><i class="ti ti-circle-plus me-1"></i>Add New</a>
                    </div>	
                    <ul class="deals-info">
                        <li>
                            <img src="<?php echo base_url()?>assets/img/profiles/avatar-21.jpg" alt="Image">
                    ...
                    <div  class="tab-content pt-0">
                        ...
                        <div  class="tab-pane fade" id="email">
                            <div class="view-header">
                                ...
                                <ul>
                                    <li>
                                        <a href="javascript:void(0);" class="com-add" data-bs-toggle="tooltip"  data-bs-placement="left" data-bs-custom-class="tooltip-dark" data-bs-original-title="There are no email accounts configured, Please configured your email account in order to Send/ Create EMails"><i class="ti ti-circle-plus me-1"></i>Create Email</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="files-activity">
        ...
        <div class="toggle-body">
            <div class="toggle-height">
                ...
                <div class="submit-button text-end">
                    ...
                    <a href="<?php echo base_url()?>deals-details" class="btn btn-primary">Create</a>
                </div>
            </div>
        </div>
    </div>
