														...
														<ul>
															<li>
																...
																<div class="status-toggle">
																	<input type="checkbox" id="col-type" class="check">
																	<label for="col-type" class="checktoggle"></label>
																</div>
															</li>
															<li>
																<p><i class="ti ti-grip-vertical"></i>Amount</p>
																<div class="status-toggle">
																	<input type="checkbox" id="col-amount" class="check">
																	<label for="col-amount" class="checktoggle"></label>
																</div>
															</li>
															<li>
															...
															<li>
																<p><i class="ti ti-grip-vertical"></i>Payment Type</p>
																<div class="status-toggle">
																	<input type="checkbox" id="col-payment" class="check">
																	<label for="col-payment" class="checktoggle"></label>
																</div>
															</li>
															<li>
													...
													<div class="filter-dropdown-menu dropdown-menu  dropdown-menu-xl-end">
														<div class="filter-set-view">
															...
															<div class="accordion" id="accordionExample">
																...
																<div class="filter-set-content">
																	<div class="filter-set-content-head">
																		<a href="#" class="collapsed" data-bs-toggle="collapse" data-bs-target="#Payment" aria-expanded="false" aria-controls="Payment">Payment Type</a>
																	</div>
																	<div class="filter-set-contents accordion-collapse collapse" id="Payment" data-bs-parent="#accordionExample">
																		<div class="filter-content-list">
																			<ul>
																				<li>
																					<div class="filter-checks">
