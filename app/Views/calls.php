                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 col-sm-8">					
                                    <div class="export-list text-sm-end">
                                        <ul>							
                                            <li>
                                                <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_calls"><i class="ti ti-square-rounded-plus"></i>Add New Call Reason</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
<!-- Add New Calls -->
<div class="modal custom-modal fade" id="add_calls" role="dialog">
...
<!-- Edit Calls -->
<div class="modal custom-modal fade" id="edit_calls" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
...
<!-- Delete Calls -->
<div class="modal custom-modal fade" id="delete_calls" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
