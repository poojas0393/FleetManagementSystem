		...
		<div class="account-content">
			<div class="login-wrapper">
                <div class="login-content">
                    <form action="<?php echo base_url();?>login-2">
                        <div class="login-user-info">
                           ...
                           <div class="login-form text-center">
                               <h6>Return to<a href="<?php echo base_url();?>login-2" class="hover-a"> Log In</a></h6>
                           </div>
                ...
                <div class="login-img">
                    <img src="<?php echo base_url();?>assets/img/authentication/forgot-img.png" class="img-fluid" alt="Register">
                </div>
            </div>
		</div>
