            ...
            <div class="modal-body">
                <div class="success-message text-center">
                    ...
                    <div class="col-lg-12 text-center modal-btn">
                        ...
                        <a href="<?php echo base_url();?>campaign-archieve" class="btn btn-danger">Yes, Delete it</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="success-message text-center">
                    ...
                    <div class="col-lg-12 text-center modal-btn">
                        <a href="#" class="btn btn-light" data-bs-dismiss="modal">Cancel</a>
                        <a href="<?php echo base_url();?>campaign-archieve" class="btn btn-primary">View Details</a>
                    </div>
                </div>
            </div>
        </div>
