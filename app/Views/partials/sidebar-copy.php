            ...
            <ul>
                ...
                <li>
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class="<?php echo ($page == 'chat'|| $page =='calendar'|| $page == 'email'|| $page == 'todo'|| $page == 'notes'|| $page == 'file-manager'|| $page =='video-call'|| $page =='audio-call'|| $page =='call-history') ? 'subdrop active' : '' ;?>"><i
                                    class="ti ti-brand-airtable"></i><span>Employee</span><span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li><a class="<?php echo ($page == 'chat') ? 'active' : '' ;?>"
                                        href="<?php echo base_url(); ?>chat">Add Employee</a></li>
                                        
                                <li><a class="<?php echo ($page == 'calendar') ? 'active' : '' ;?>"
                                        href="<?php echo base_url(); ?>calendar">Employee Listing</a></li>
                ...
                <li>
                    ...
                    <li class="submenu">
                            ...
                            <ul>
                                <li><a class="<?php echo ($page == 'chat') ? 'active' : '' ;?>"
                                        href="<?php echo base_url(); ?>chat">Add Foreman</a></li>
                                        
                                <li><a class="<?php echo ($page == 'calendar') ? 'active' : '' ;?>"
                                        href="<?php echo base_url(); ?>calendar">Foreman Listing</a></li>
                                <li><a class="<?php echo ($page == 'chat') ? 'active' : '' ;?>"
                                        href="<?php echo base_url(); ?>chat">Add Driver</a></li>
                                <li><a class="<?php echo ($page == 'calendar') ? 'active' : '' ;?>"
                                        href="<?php echo base_url(); ?>calendar">Driver Listing</a></li>
