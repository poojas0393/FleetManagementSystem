        ...
        <div class="row">
            ...
            <div class="col-xl-3 theiaStickySidebar">
                <div class="contact-sidebar">
                    ...
                    <ul class="set-info">
                        <li>
                            <a href="javascript:void(0);"><i class="ti ti-share-2"></i>Share Contact</a>
                        </li>
                        <li>
                            <a href="javascript:void(0);"><i class="ti ti-star"></i>Add to Favourite</a>
                        </li>
                        <li>
                            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_contact"><i class="ti ti-trash-x"></i>Delete Contact</a>
                        </li>
                    </ul>
                </div>
            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="profile-pic-upload">
                                                <div class="profile-pic">
                                                    <span><img src="<?php echo base_url();?>assets/img/profiles/avatar-20.jpg" alt="img"></span>
                                                    <a href="javascript:void(0);" class="close-img"><i class="ti ti-x"></i></a>
                                                </div>
