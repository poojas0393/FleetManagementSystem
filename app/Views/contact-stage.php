                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 col-sm-8">					
                                    <div class="export-list text-sm-end">
                                        <ul>							
                                            <li>
                                                <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_contact_stage"><i class="ti ti-square-rounded-plus"></i>Add New Stages</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
<div class="modal custom-modal fade" id="add_contact_stage" role="dialog">
...
<!-- Edit Contact Stage -->
<div class="modal custom-modal fade" id="edit_contact_stage" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal custom-modal fade" id="delete_contact_stage" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
