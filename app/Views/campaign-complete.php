                                                ...
                                                <div class="filter-set-view">
                                                    ...
                                                    <div class="filter-reset-btns">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6">
                                                                <a href="<?php echo base_url();?>campaign-complete" class="btn btn-primary">Filter</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<div class="toggle-popup">
    <div class="sidebar-layout">
        ...
        <div class="toggle-body">
            <form action="<?php echo base_url();?>campaign-archieve" class="toggle-height">
            ...
            <div class="modal-body">
                <div class="success-message text-center">
                    ...
                    <div class="col-lg-12 text-center modal-btn">
                        ...
                        <a href="<?php echo base_url();?>campaign-complete" class="btn btn-danger">Yes, Delete it</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="success-message text-center">
                    ...
                    <div class="col-lg-12 text-center modal-btn">
                        <a href="#" class="btn btn-light" data-bs-dismiss="modal">Cancel</a>
                        <a href="<?php echo base_url();?>campaign-complete" class="btn btn-primary">View Details</a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal custom-modal fade" id="save_view" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo base_url();?>campaign-complete">
                    <div class="form-wrap">
