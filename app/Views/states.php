										...
										<div class="col-md-7 col-sm-8">					
											<div class="export-list text-sm-end">
												<ul>
													...
													<li>
														<a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_state"><i class="ti ti-square-rounded-plus"></i>Add State</a>
													</li>
												</ul>
											</div>
										</div>
													...
													<div class="filter-dropdown-menu dropdown-menu  dropdown-menu-xl-end">
														<div class="filter-set-view">
															...
															<div class="accordion" id="accordionExample">
																...
																<div class="filter-set-content">
																	<div class="filter-set-content-head">
																		<a href="#" class="collapsed" data-bs-toggle="collapse" data-bs-target="#State" aria-expanded="false" aria-controls="State">State Name</a>
																	</div>
