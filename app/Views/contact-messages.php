                                ...
                                <div class="col-md-7 col-sm-8">					
                                    <div class="export-list text-sm-end">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="javascript:void(0);" class="btn btn-primary add-popup"><i class="ti ti-square-rounded-plus"></i>Add Contact Messages</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
...
<div class="toggle-popup">
    <div class="sidebar-layout">
        ...
        <div class="toggle-body">
            <form action="<?php echo base_url();?>contact-messages" class="toggle-height">	
