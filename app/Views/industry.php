                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 col-sm-8">					
                                    <div class="export-list text-sm-end">
                                        <ul>							
                                            <li>
                                                <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_industry"><i class="ti ti-square-rounded-plus"></i>Add New Industry</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
